...
export default function SelectedLanguage({ selectedLanguageCode }) {
  return (
    <div className="flex items-center justify-center pl-1 pr-2 transition-colors duration-300 ease-linear rounded-sm cursor-pointer w-36 h-11 hover:bg-stone-200 bg-stone-100">
